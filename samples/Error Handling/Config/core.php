 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfIxfs2guVoUubWwvniR2G0gnrC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859309657164542496749683645');
...
Configure::write('OpenApi', array(
    ...
    */
    'VersionTypes' => array(
        'Controller', 'Controller/Component/Auth'
    ),
    ...
    /**
     * Specify a custom error class, this class must implement the IApiError interface or extend the BaseApiError class
     */    
    'ErrorClass' => 'OpenApiCustomApiError',
    /**
     * Specify a custom error controller
     */
    'ErrorController' => 'OpenApiCustomErrorController'    
));
